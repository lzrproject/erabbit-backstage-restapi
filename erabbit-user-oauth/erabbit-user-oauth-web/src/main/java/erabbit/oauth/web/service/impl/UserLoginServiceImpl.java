...
public class UserLoginServiceImpl implements UserLoginService {
    ...
    @Override
    public AuthToken login(String clientId, String clientSecret, String grant_type) throws Exception {
        log.info("threadLocal get线程：{}",Thread.currentThread().getId());
        User user = LoginController.map.get();
